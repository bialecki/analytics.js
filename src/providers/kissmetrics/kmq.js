// KISSmetrics tracking script for My First Product
// Generated: Mon Jan 07 01:31:40 -0500 2013
if (typeof(KM) == 'undefined') {
    var KM_KEY = "bced4d55c7b0e53d1aaf683b80169bd47412c0c3";
    ...
    KM.trackClickOnOutboundLink = function(a, b, c) {
        KM.e$(a, function(d) {
            KM.ev(d, "click", function(g) {
                ...
                var f = KM.sre(g);
                while (f && (!f.href || f.nodeName.toLowerCase() != "a")) {
                    f = f.parentNode
                }
    ...
    KM.abv = {};
    KM.ab = function(n, p, q) {
        if (!n) {
            return null
        }
        if (typeof(KM.abv[n]) != "undefined") {
            if (q) {
                q(KM.abv[n])
            }
            return KM.abv[n]
    ...
    KM.umf = function(e, d, j) {
        if (!d) {
            d = KM.u()
        }
        if (j) {
            if (e.indexOf("/") == 0 || d.indexOf("/") == 0) {
                e = KM.ushnh(e.toLowerCase());
                d = KM.ushnh(d.toLowerCase())
            } else {
                var i = /^https?:\/\//i;
                if (!e.match(i) || !d.match(i)) {
                    e = KM.usp(e.toLowerCase());
                    d = KM.usp(d.toLowerCase())
                }
                e.replace(/^www\./, "");
                d.replace(/^www\./, "")
            }
    ...
    KM.um = function(c, b) {
        var a = (typeof KM_INCLUDE_HOSTNAME != "undefined" && KM_INCLUDE_HOSTNAME);
        return KM.umf(c, b, a)
    };
    KM.usp = function(a) {
        a = a.replace(/^https?:\/\//i, "");
    ...
    KM.vcd = function(b) {
        var a = new Date()
            .getTime();
        document.cookie = "kvcd=" + a + "; domain=" + b + "; path=/;";
        return ((document.cookie + "")
            .indexOf("kvcd=" + a) != -1)
    };
    KM.gcd = function() {
        if (typeof(KM_COOKIE_DOMAIN) == "undefined" || !KM_COOKIE_DOMAIN) {
            var b = document.location.host.toLowerCase()
                .split(":")[0];
            var e = b.split(".");
            var d = [];
            ...
            if (typeof(KM_COOKIE_DOMAIN) == "undefined" || !KM_COOKIE_DOMAIN) {
                KM_COOKIE_DOMAIN = "." + KM.bd(b)
            }
        }
        return KM_COOKIE_DOMAIN
    };
    KM.sc = function(a, c, b, d) {
        KM.lc[a] = c;
        KM.sdc(KM.cp + a, c, b)
    };
    ...
    KM.rf = function() {
        if (typeof(KM_REFERRER) != "undefined") {
            return KM_REFERRER
        }
    ...
    KM.trackSearchHits = function() {
        ...
        for (var a in f) {
            var j = f[a];
            if (typeof(j) == "object") {
                var b = KM.uprts(KM.rf(), (j.t && j.t == "path"));
                ...
                if (k && k.match(e) !== null) {
                    ...
                    if (j.q.substr(0, 1) == "/") {
                        if (b.path) {
                            if (b.path.indexOf(j.q) === 0) {
                                g = b.path.substr(j.q.length);
                                var c = g.indexOf("/");
                                if (c !== -1) {
                                    g = g.substr(0, c)
                                }
    ...
    KM.dnt = function() {
        try {
            if (typeof(KM_DNT) != "undefined" && KM_DNT) {
                if (typeof(KMDNTH) != "undefined" && KMDNTH) {
                    return 1
                }
                var c = document.navigator;
                if (c && c.doNotTrack) {
                    return 1
                }
                var a = window.external;
                if (a) {
                    if (a.InPrivateFilteringEnabled()) {
                        return 1
                    }
                    if (a.msTrackingProtectionEnabled()) {
                        return 1
                    }
                }
            }
    ...
    KM.bt = function(a) {
        ...
        return a.match(/bot|spider|crawl|mediapartners|archive|slurp|agent|grab/i) ? true : false
    };
    ...
    KM.ce = function(e, b, a) {
        var c;
        var f = document;
        if (typeof b != "undefined" && f.getElementById(b)) {
    ...
    KM.iud = function() {
        KM.ud = 0;
        if (typeof(KM_COOKIES_ONLY) == "undefined" || !KM_COOKIES_ONLY) {
            if (!KM.ls) {
                try {
                    KM.ude = KM.ce("div", "userdata_el", 1);
                    KM.ud = KM.ude.addBehavior ? 1 : 0;
                    if (KM.ud) {
                        KM.ude.style.behavior = "url(#default#userData)";
                        KM_NO_SWF = 1
                    }
                } catch (a) {}
            }
    ...
    KM.udg = function(a) {
        try {
            if (KM.ud && KM.ude) {
                ...
                if (b == "null" || b == "undefined" || b === undefined || b === null) {
                    return null
                } else {
                    if (b == "false") {
                        return false
    ...
    if (!KM.cdr()) {
        KM.idr = function() {
            ...
            if (b.addEventListener) {
                b.addEventListener("DOMContentLoaded", KM.odr, true);
                b.addEventListener("readystatechange", KM.cdr, true);
                a.addEventListener("load", KM.odr, true)
            } else {
                if (b.attachEvent) {
                    b.attachEvent("onreadystatechange", KM.cdr);
                    a.attachEvent("onload", KM.odr)
                }
            }
        };
        KM.idr()
    ...
    if (window.addEventListener) {
        window.addEventListener("message", function(a) {
            if (a.origin && a.origin.match(/\.kissmetrics\.com/) && a.data == "KM_HELLO:" + KM_KEY && window.opener && window.opener.postMessage) {
                window.opener.postMessage("KM_IDENTITY=" + KM.i(), "*")
            }
        }, false)
    };
}